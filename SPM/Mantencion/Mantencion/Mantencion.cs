...
namespace APP {
  ...
  public partial class Mantencion : FrmBaseGrid {
    ...
    public override void InicializarFiltros(bool guardaPersistencia = true) {
      ...
      Filtro.Agregar(new FiltroDropDown(ddlPlantaOrigen, chkPlantaOrigen, TIPO_OPERADOR.Igual, "Planta.nombre_Planta", "nombre_Planta", TIPO_DATO.Entero));
      Filtro.Agregar(new FiltroTextBox(txtUsuario, chkUsuario, TIPO_OPERADOR.Contiene, "Usuarios.nombre_empleado", "nombre_empleado", TIPO_DATO.Texto));
      Filtro.Agregar(new FiltroTextBox(txtNumero, chkNumero, ddlNumero, "Mantencion.Numero", "Numero", TIPO_DATO.Entero));
      Filtro.Agregar(new FiltroDatePicker(dtpFechaDesde, chkFechaDesde, ddlFechaDesde, "Mantencion.Fecha", "", TIPO_DATO.Fecha, TIPO_OPERADOR.MayorIgual));
      Filtro.Agregar(new FiltroDatePicker(dtpFechaHasta, chkFechaHasta, ddlFechaHasta, "Mantencion.Fecha", "", TIPO_DATO.Fecha, TIPO_OPERADOR.MenorIgual));
      Filtro.Agregar(new FiltroListBox(lstEstado, chkEstado, ddlEstadoMant, "MantencionEstado.Estado", "IdEstado", TIPO_DATO.Entero));
    }
    ...
    private bool Eliminar() {
      return null != this.XEjecutarProcedimiento(null, "MantencionDel", TomarId(dtgPrincipal));
    }
    ...
    public override void CargarPagina(int pagina, int pagTamano, int cantidad) {
      ...
      var dtTabla = Global.DatosApp.TraerTabla("MantencionSel_Grids", objParam);
    ...
    private void tsbModificar_Click(object sender, EventArgs e) {
      Global.LlamarFormulario<MantencionAct>(false, TomarId(dtgPrincipal));
    }
    ...
    private void tsbNuevo_Click(object sender, EventArgs e) {
      Global.LlamarFormulario<MantencionAct>(false, -1);
    }
