...
namespace APP {
  ...
  public partial class DocCategoria : FrmBaseGrid {
    ...
    public override GUARDAR_RESULT GuardarTodo() {
      ...
      List<Registro> listaResultados = Global.DatosApp.ActualizarMasivo("DocCategoria", listaCambios, false);
      ...
      Global.Cache.EliminarTabla(ClaseCache.TABLA.DocCategoria);
    ...
    public override void RefrescarTodo() {
      ...
      Cursor = Cursors.WaitCursor;
      DataTable dtTabla = Global.DatosApp.TraerTabla("DocCategoriaSel_Grids");
      Cursor = Cursors.Default;
      if (dtTabla != null) {
    ...
    private void ValidarFila(DataRow dtrFila) {
      ...
      if (dtrFila.XEsNuloOVacio("Categoria"))
