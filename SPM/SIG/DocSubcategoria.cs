...
namespace APP {
  ...
  public partial class DocSubcategoria : FrmBaseGrid {
    ...
    public override GUARDAR_RESULT GuardarTodo() {
      ...
      List<Registro> listaResultados = Global.DatosApp.ActualizarMasivo("DocSubCategoria", listaCambios, false);
      ...
      Global.Cache.EliminarTabla(ClaseCache.TABLA.DocSubcategoria);
    ...
    public override void RefrescarTodo() {
      ...
      Cursor = Cursors.WaitCursor;
      DataTable dtTabla = Global.DatosApp.TraerTabla("DocSubCategoriaSel_Grids");
      Cursor = Cursors.Default;
      if (dtTabla != null) {
    ...
    private void ValidarFila(DataRow dtrFila) {
      ...
      if (dtrFila.XEsNuloOVacio("IdCategoria"))
        stbError.AppendLine("Categoría es requerido");

      if (dtrFila.XEsNuloOVacio("Subcategoria"))
        stbError.AppendLine("Subcategoría es requerido");
    ...
    private void LlenarDdls() {
      colIdCategoria.DisplayMember = "Categoria";
      colIdCategoria.ValueMember = "Id";
      colIdCategoria.DataSource = Global.Cache.TomarVista(ClaseCache.TABLA.DocCategoria, "Id > 0", colIdCategoria.DisplayMember);
    }
