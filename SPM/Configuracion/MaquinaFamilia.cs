...
namespace APP {
  ...
  public partial class MaquinaFamilia : FrmBaseGrid {
    ...
    public override GUARDAR_RESULT GuardarTodo() {
      ...
      List<Registro> listaResultados = Global.DatosApp.ActualizarMasivo("MaquinaFamilia", listaCambios, false);
      ...
      Global.Cache.EliminarTabla(ClaseCache.TABLA.MaquinaFamilia);
    ...
    public override void RefrescarTodo() {
      ...
      Cursor = Cursors.WaitCursor;
      DataTable dtTabla = Global.DatosApp.TraerTabla("MaquinaFamiliaSel_Grids");
      Cursor = Cursors.Default;
      if (dtTabla != null) {
