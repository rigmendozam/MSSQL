...
namespace APP {
  ...
  public partial class Maquina : FrmBaseGrid {

    #region Declaraciones

    #region Por Defecto

    private static readonly ACCESO_OPCION Acceso = ACCESO_OPCION.PlanMantencion;
    ...
    public override GUARDAR_RESULT GuardarTodo() {
      ...
      List<Registro> listaResultados = Global.DatosApp.ActualizarMasivo("Maquina", listaCambios, false);
      Global.Cache.EliminarTabla(ClaseCache.TABLA.Maquina);
    ...
    public override void RefrescarTodo() {
      ...
      Cursor = Cursors.WaitCursor;
      DataTable dtTabla = Global.DatosApp.TraerTabla("MaquinaSel_Grids");
      Cursor = Cursors.Default;
      if (dtTabla != null) {
    ...
    private void LlenarDdls() {
      ...
      colIdFamilia.DisplayMember = "Familia";
      colIdFamilia.ValueMember = "Id";
      colIdFamilia.DataSource = Global.Cache.TomarVista(ClaseCache.TABLA.MaquinaFamilia, "Id > 0", colIdFamilia.DisplayMember);
    }
