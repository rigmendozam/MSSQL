namespace APP {
  partial class MaquinaFamilia {
    ...
    private void InitializeComponent() {
      ...
      // colFamilia
      // 
      this.colFamilia.AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.Fill;
      this.colFamilia.DataPropertyName = "Familia";
      this.colFamilia.HeaderText = "Familia";
      this.colFamilia.MaxInputLength = 100;
      ...
      this.Name = "MaquinaFamilia";
      this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
      this.Text = "Familia de máquinas";
